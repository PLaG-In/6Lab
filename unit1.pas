...
begin
  ...
  {создаем bitmap для заднего мяча}
  ball := TBitmap.Create;
  LoadImageOrDie(ball, 'ball.bmp');
  {настраиваем прозрачность мяча}
